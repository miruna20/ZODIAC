...
def collate_func(batch):
    ...
    if 'img_condition' in output:
        output['img_condition'] = torch.stack(output['img_condition'])

    if 'projection_matrix' in output:
        output['projection_matrix'] = torch.stack(output['projection_matrix'])
