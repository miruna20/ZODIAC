...
class UNet3DModel(nn.Module):
    ...
    def forward(self, x = None, doctree = None, unet_lr = None, timesteps = None, label = None, context = None, as_middle=False, img_condition=None, projection_matrix=None, kernel_size=None, **kwargs):
        """
        ...
        if unet_lr is not None:
            ...
            h_lr = unet_lr.forward_as_middle(h, doctree, timesteps, label, context, img_condition, projection_matrix, kernel_size)
