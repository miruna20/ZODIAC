#!/bin/bash
# TP-ODIAC inference — multi-seed (paper reproduction): 10 seeds (42-51) x {Balgrist, phantom},
...
# Output: results/inference/tpodiac/<dataset>/<scan>/seed_<n>.obj
#
# Run from anywhere: bash scripts/inference_TPODIAC/run_multiseed.sh [GPU_ID]
...
echo "=== TP-ODIAC multi-seed complete: results/inference/${VARIANT}/ ==="
