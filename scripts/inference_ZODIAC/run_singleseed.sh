#!/bin/bash
# ZODIAC inference — single seed (42), quick run on Balgrist + phantom.
# Output: results/inference/zodiac/<dataset>/<scan>/seed_42.obj (directly evaluatable)
#
# Run from anywhere: bash scripts/inference_ZODIAC/run_singleseed.sh [GPU_ID]
...
echo "=== ZODIAC single-seed complete: results/inference/${VARIANT}/<dataset>/<scan>/seed_42.obj ==="
